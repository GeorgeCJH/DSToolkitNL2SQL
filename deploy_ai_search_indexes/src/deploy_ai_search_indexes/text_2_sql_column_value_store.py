...
import os
from nl2sql.nl2sql_core.utils.database import DatabaseEngine
from nl2sql.nl2sql_core.connectors.factory import ConnectorFactory
    ...
    def get_index_fields(self) -> list[SearchableField]:
        ...
        fields = [
            ...
            SearchableField(
                name="Value",
                type=SearchFieldDataType.String,
                analyzer_name="ko.microsoft",  # comment out if it is first time deployment.
                hidden=False,
            ),
            SimpleField(
