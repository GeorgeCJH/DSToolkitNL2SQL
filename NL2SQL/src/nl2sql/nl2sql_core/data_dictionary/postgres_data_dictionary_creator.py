...
from .data_dictionary_creator import (
...
from ..connectors.postgres_sql import PostgresSqlConnector
...
if __name__ == "__main__":
    # Ensure Windows-compatible event loop for psycopg async
    if sys.platform.startswith("win"):
        try:
            asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
        except Exception as e:
            # Non-fatal: just log; fall back to default
            import logging
